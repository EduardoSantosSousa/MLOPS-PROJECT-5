...
class DataProcessing:
    ...
    def feature_selection(self):
        try:
          X_train, _, y_train, _ = train_test_split(self.X,self.y, test_size=0.2,
          ...
          logger.info("Feature selection done....")
            ...
            raise CustomException("Failed to feature selection data", e)
    ...
    def save_data_and_scaler(self, X_train, X_test, y_train, y_test ):
        try:
            ...
            logger.error(f"Error while spliting and saving data {e}")
    ...
    def run(self):
        ...
        logger.info("Data Processing Pipiline execusted sucesfuly.......")


if __name__ =="__main__":
    processor = DataProcessing(input_path=RAW_DATA, output_path=PROCESSED_DIR)
    processor.run()
